    ...
    <footer className="footer--container">
      <div className="footer--link--container">
        <div className="navbar--logo--container">
          <img src="./img/LucasUmbergerLogo.png" alt="Lucas Umberger Logo" />
          <p className="logoTitle">Lucas Umberger</p>
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.instagram.com/lucas.umberger/"
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/lumberger540/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made by Lucas Umberger</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
